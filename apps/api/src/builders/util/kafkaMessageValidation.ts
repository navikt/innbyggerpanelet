...
export const GROUPING_ID_MAX_LENGTH: number = 100
export const NAMESPACE_MAX_LENGTH: number = 100;
export const APP_NAME_MAX_LENGTH: number = 100;
export const BESKJED_MAX_LENGTH: number = 300
export const EMAIL_MESSAGE_MAX_LENGTH: number = 4000
export const EMAIL_TITLE_MAX_LENGTH: number = 40
export const SMS_MESSAGE_MAX_LENGTH: number = 160
