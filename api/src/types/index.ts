...
export interface IUser {
    [key: string]: string | ICandidate[] | ICriteria[] | IInsightProject[] | boolean | undefined
    id: string
    firstname: string
    surname: string
    registered: boolean
...
export interface IInsight {
    [key: string]: string | number | Date | ICriteria[] | IConsent[] | ICandidate[] | IInsightProject // String indexation
    id: number
    name: string
    description: string
    start: string
